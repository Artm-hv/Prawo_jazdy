...
class TestEngine {
  ...
  render() {
    ...
    let mediaHtml = '';
    if (q.media_url) {
      if (q.media_type === "video" || q.media_url.endsWith(".mp4")) {
        mediaHtml = `<video src="${q.media_url}" autoplay loop muted class="exam-media-img" style="max-height:400px; width:100%; object-fit:contain; border-radius:8px;"></video>`;
      } else {
